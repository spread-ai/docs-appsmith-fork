---
Title: Custom
Description: Custom widget reference
---
...
1. Widget size.
2. `--appsmith-ui-width` and `--appsmith-ui-height` are number types, to convert them to px, you can use: `calc(var(--appsmith-ui-width) * 1px)`.
3. Application theme and styling.
