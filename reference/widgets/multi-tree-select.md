...
Description: Multi-Tree Select widget reference
---
...
Allows you to specify initial values for the widget when it's first displayed. This is useful for pre-populating the widget or ensuring that specific options are selected by default.
